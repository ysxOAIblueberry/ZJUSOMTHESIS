...
% Documents  : https://thenetadmin.github.io/zjuthesisk
...
\newcommand{\FormatStudentName}{%
    % 获取名字长度
    \StrLen{\StudentName}[\nameLen]%
    % 判断：如果长度等于 2
    \ifnum\nameLen=2%
        % 取第1个字 + 空格 + 取第2个字
        \StrChar{\StudentName}{1}\quad\StrChar{\StudentName}{2}%
    \else%
        % 否则直接输出原名字
        \StudentName%
    \fi%
...
\newcommand{\FormatAdvisorName}{%
    % 获取名字长度
    \StrLen{\AdvisorName}[\nameLen]%
    % 判断：如果长度等于 2
    \ifnum\nameLen=2%
        % 取第1个字 + 空格 + 取第2个字
        \StrChar{\AdvisorName}{1}\quad\StrChar{\AdvisorName}{2}%
    \else%
        % 否则直接输出原名字
        \AdvisorName%
    \fi%
